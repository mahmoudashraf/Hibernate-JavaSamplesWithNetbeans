        ...
        // TODO code application logic here
         ...
         try {
            ...
            session.getTransaction().commit();
             ...
             Filter fil = session.enableFilter("bynamed");
             fil.setParameter("bynameflter", 2);
             org.hibernate.Query que = session.createQuery("from Person"); 
...
/**
 condition=":bynameflter = pk" 
 * condition is maped to the column name not the class's property 
